<?php
/**
 * MyProtector Platform - Footer Partial Component
 * 
 * Reusable footer component with navigation and social links
 * Uses WordPress theme integration
 *
...
// Get configuration - check both constants and CustomizerSettings
...
$cookie_url = defined('MYPROTECTOR_COOKIE_URL') ? MYPROTECTOR_COOKIE_URL : home_url('/cookies');
        ...
        <div class="mp-footer-grid">
            ...
            <div class="mp-footer-brand">
                ...
                <div class="mp-footer-social">
                    ...
                    <a href="<?php echo esc_url($twitter_url); ?>" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                ...
                <ul class="mp-footer-links">
                    ...
                    <li>
                        <a href="<?php echo esc_url($founder_linkedin); ?>" target="_blank" rel="noopener noreferrer">
                            Meet <?php echo esc_html($founder_name); ?>
                        </a>
                    </li>
                </ul>
            </div>
